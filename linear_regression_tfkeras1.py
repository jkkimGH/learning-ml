...
# Takes around 450 epochs to get it right

# If the learning rate is set to 100:
  # The resulting model is terrible; the red line doesn't align with the blue dots. 
  # Furthermore, the loss curve oscillates like a roller coaster. An oscillating loss curve strongly suggests that the learning rate is too high.

# Learning Rate of ~0.1 and ~50 epochs: pretty good

# Changing batch size from 12 to 1 still works (SGD)
